		...
		$(function(){
			$('#data-table').datagrid( {
				...
				columns:[[
				    ...
				    {field : 'added',title : '航班编号',halign:'center',width : 120},
				    {field : 'rebatetype',title : '购票时间',halign:'center',width : 150},
				    {field : 'rebate',title : '订单号',halign:'center',width : 80},
				    {field : 'airewayid',title : '票价',halign:'center',width : 80}, 
				    {field : 'classtype',title : '状态',halign:'center',width : 80},
				]]
			});
