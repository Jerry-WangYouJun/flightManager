...
<body>
	...
	<form:form id="instockForm"  action="${basePath}/instock/save" modelAttribute="instock" method="post">
		<c:if test="${instock.id != null }">
			<form:hidden path="id"/>
			<%-- <form:hidden path="instockstate"/> --%>
		...
		<table width="100%" class="table" cellpadding="0" cellspacing="0">
		  	<tr>
		  		...
		  		<td class="td">
		  			<form:input id="instockNo" path="instockno"/>
		  		</td>
		  		<td class="td">入库仓库：</td>
		  		<td class="td">
		  		...
		  		<td class="td">入库日期：</td>
		  		<td class="td">
		  			<form:input path="instockdate"  class="easyui-datebox" data-options="currentText:'今日',closeText:'关闭',editable:false"/>
		  		</td>
		  	</tr>
		  	<tr>
		  		<td class="td">供货商：</td>
